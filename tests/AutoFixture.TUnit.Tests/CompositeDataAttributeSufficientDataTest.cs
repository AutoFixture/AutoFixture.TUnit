...
public class CompositeDataAttributeSufficientDataTest
{
        ...
        IEnumerable<object[]> expectedResult)
    {
        ...
        // Act
        var result = attribute.GenerateDataSources(DataGeneratorMetadataHelper.CreateDataGeneratorMetadata(this._method))
            .Select(x => x())
            .ToArray();
        ...
        IEnumerable<object[]> ExpectedResult)> GetEnumerator()
    {
        yield return CreateTestData(
            data:
            [
                new FakeDataAttribute(this._method, [[1, 2, 3]])
            ],
            expected:
            [
                [1, 2, 3]
        ...
        yield return CreateTestData(
            ...
            [
                new FakeDataAttribute(this._method, [[1, 2, 3]]),
                new FakeDataAttribute(this._method, [[4, 5, 6]])
            ],
            expected:
            [
                [1, 2, 3]
        ...
        yield return CreateTestData(
            data:
            [
                new FakeDataAttribute(this._method, [[1]]),
                new FakeDataAttribute(this._method, [[2, 3, 4]])
            ],
            expected:
            [
                [1, 3, 4]
        ...
        yield return CreateTestData(
            data:
            [
                new FakeDataAttribute(this._method, [[1, 2]]),
                new FakeDataAttribute(this._method, [[3, 4, 5]])
            ],
            expected:
            [
                [1, 2, 5]
        ...
        yield return CreateTestData(
            data:
            [
                new FakeDataAttribute(this._method, [[1, 2, 3], [4, 5, 6]])
            ],
            expected:
            [
                [1, 2, 3],
        ...
        yield return CreateTestData(
            ...
            [
                new FakeDataAttribute(this._method, [[1, 2, 3], [4, 5, 6]]),
                new FakeDataAttribute(this._method,
                    [[7, 8], [9, 10], [11, 12]])
            ],
            expected:
            [
        ...
        yield return CreateTestData(
            ...
            [
                new FakeDataAttribute(this._method, [[1, 2, 3], [4, 5, 6]]),
                new FakeDataAttribute(this._method, [[7, 8, 9]])
            ],
            expected:
            [
                [1, 2, 3]
        ...
        yield return CreateTestData(
            ...
            [
                new FakeDataAttribute(this._method, [[1, 2, 3]]),
                new FakeDataAttribute(this._method, [[4, 5, 6], [7, 8, 9]])
            ],
            expected:
            [
                [1, 2, 3]
        ...
        yield return CreateTestData(
            ...
            [
                new FakeDataAttribute(this._method, [[1, 2]]),
                new FakeDataAttribute(this._method, [[3, 4]])
            ],
            expected:
            [
                [1, 2]
        ...
        yield return CreateTestData(
            ...
            [
                new FakeDataAttribute(this._method, [[1]]),
                new FakeDataAttribute(this._method, [[2, 3]])
            ],
            expected:
            [
                [1, 3]
        ...
        yield return CreateTestData(
            ...
            [
                new FakeDataAttribute(this._method, [[1]]),
                new FakeDataAttribute(this._method, [[2]]),
                new FakeDataAttribute(this._method, [[3]])
            ],
            expected:
            [
                [1]
